...
public class tasks {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(checkEmail("nikiforenko@gmail.com"));
        System.out.println(checkEmail(".nik iforenko@gmail.com"));
        System.out.println(checkEmail("nikiforenko.@.gmail.com"));
        System.out.println(checkEmail("nikiforenko@gmail"));
        System.out.println(checkEmail("nikiforenko@g@mail.ru"));
